...
public class EntregadorV1ControllerTests {
    ...
    class EntregadorVerificacaoFluxosBasicosApiRest {
        ...
        void quandoBuscamosTodosEntregadores() throws Exception {
            ...
            List<EntregadorGetRequestDTO> resultado = objectMapper.readValue(responseJsonString, new TypeReference<>() {
            });
        ...
        void quandoBuscamosEntregadorPorId() throws Exception {
            ...
            List<EntregadorGetRequestDTO> listaResultados = objectMapper.readValue(responseJsonString, new TypeReference<>() {
            });

            EntregadorGetRequestDTO resultado = listaResultados.stream().findFirst().orElse(EntregadorGetRequestDTO.builder().build());
