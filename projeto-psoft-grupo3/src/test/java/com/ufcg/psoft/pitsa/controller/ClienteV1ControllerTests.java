...
public class ClienteV1ControllerTests {
    ...
    final String URI_CLIENTES = "/v1/clientes";
    ...
    class ClienteVerificacaoFluxosBasicosApiRest {
        ...
        void quandoBuscamosPorUmClienteSalvo() throws Exception {
            ...
            List<Cliente> listaResultados = objectMapper.readValue(responseJsonString, new TypeReference<>() {
            });
            Cliente resultado = listaResultados.stream().findFirst().orElse(Cliente.builder().build());
