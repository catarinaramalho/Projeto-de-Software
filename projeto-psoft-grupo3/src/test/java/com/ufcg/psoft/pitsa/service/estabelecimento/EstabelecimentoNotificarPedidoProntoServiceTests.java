...
class EstabelecimentoNotificarPedidoProntoServiceTests {

    @Autowired
    EstabelecimentoNotificarPedidoProntoService driver;
    ...
    void quandoNotificamosClienteSobrePedidoValido() {
        ...
        // Assert
        assertEquals("Olá, " + cliente.getNome() + "! Seu pedido #" + pedido.getId() + " está pronto e já será atribuído a um entregador.", result);
    }
